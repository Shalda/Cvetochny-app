...
var ProductEditorComponent = /** @class */ (function () {
    ...
    ProductEditorComponent.prototype.ngOnInit = function () {
        ...
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({
            ...
            'newCategory': new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]({ value: null, disabled: true }, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required] }),
            ...
            'diameter': new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](this.product.diameter || null, { validators: [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern('[0-9\\.]+$')] }),
        ...
        this.form.get('parentCategory').valueChanges
            ...
            _this.product.subcategory = null;
    ...
    ProductEditorComponent.prototype.console = function (v) {
        console.log(v);
    };
    ProductEditorComponent.prototype.save = function () {
        ...
        if (this.form.invalid) {
            ...
            if (!this.editing) {
                this.repository.addProduct(this.form.value.name, this.form.value.parentCategory, this.form.value.category, this.form.value.subcategory, this.form.value.description, this.form.value.diameter, this.form.value.price, this.form.value.img);
            }
            else {
                this.repository.updateProduct(this.product._id, this.form.value.name, this.form.value.parentCategory, this.form.value.category, this.form.value.subcategory, this.form.value.description, this.form.value.diameter, this.form.value.price, this.form.value.img);
            }
            this.formSubmitted = false;
            this.form.reset();
        ...
        var _loop_1 = function (i) {
            {
                ...
                reader_1.readAsDataURL(fileList[i]);
                reader_1.onload = function () {
                    _this.imagePreviewCollection.push(reader_1.result);
                };
            }
...
var Product = /** @class */ (function () {
    function Product(_id, name, parentCategory, category, subcategory, diameter, img, description, price, create_ts) {
        this._id = _id;
        this.name = name;
