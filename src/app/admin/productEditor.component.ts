...
export class ProductEditorComponent implements OnInit, OnDestroy {
    ...
    public noteEnable = false;
    public noteText = 'уважаемый посетитель, учитывая сезонность растений, ' +
    ...
    ngOnInit() {
        ...
        this.form = new FormGroup({
            ...
            'note': new FormControl({value: this.product.note || null, disabled: true}),
